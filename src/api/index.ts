...
export const deliverablesApi = {
  ...
  listSubtasks: (id: string) => api.get<Subtask[]>(`/deliverables/${id}/subtasks`),
  createSubtask: (id: string, body: Partial<Subtask>) => api.post<Subtask>(`/deliverables/${id}/subtasks`, body),
  updateSubtask: (id: string, subtaskId: string, body: Partial<Subtask>) =>
    api.patch<Subtask>(`/deliverables/${id}/subtasks/${subtaskId}`, body),
